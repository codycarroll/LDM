...
\begin{equation}
  ...
  \label{eq:LDM}
\end{equation}
where $\lambda$ is the latent curve, $\Psi_j \in \W$ are component transports,
and $H_i \in \W$ are subject-level warping functions.
...
averaged over aligned subjects), let $F : (L^\infty(\T))^p \to L^\infty(\T)$ denote the Karcher mean,
...
Let $F : (L^\infty(\T))^p \to L^\infty(\T)$ denote the Karcher mean,
...
$(\gamma_1,\ldots,\gamma_p)$ (with $\mu = \lambda$ at that point), provided the derivative of the
...
a continuity property of the Karcher mean. The main new ingredient
needed for a complete proof was a precise statement of the Lipschitz continuity of the SRVF Karcher mean $F$ at the point
